...
class WorkdayUrlHelperTest {
  ...
  void setUp() {
    service =
        new AtsAdapterIngestionService(
            httpClient, robotsTxtService, repository, new ObjectMapper(), new CrawlerProperties());
  }

  @Test
  void toCanonicalWorkdayUrlAcceptsAbsoluteWorkdayUrl() {
    String url =
        service.toCanonicalWorkdayUrl(
            "acme.wd5.myworkdayjobs.com",
            "External",
            "https://acme.wd5.myworkdayjobs.com/en-US/External/job/Remote/Engineer_R123");
    assertThat(url)
        .isEqualTo("https://acme.wd5.myworkdayjobs.com/en-US/External/job/Remote/Engineer_R123");
  }
  ...
  void toCanonicalWorkdayUrlRejectsInvalidHost() {
    String url =
        service.toCanonicalWorkdayUrl(
            "acme.wd5.myworkdayjobs.com", "External", "https://community.workday.com/invalid-url");
  ...
  void buildWorkdayUrlCandidatesInjectsLocaleAndSite() {
    List<String> candidates =
        service.buildWorkdayUrlCandidates(
            "acme.wd5.myworkdayjobs.com", "External", "External/job/Remote/Engineer_R123");
    assertThat(candidates).isNotEmpty();
    assertThat(candidates.getFirst())
        .isEqualTo("https://acme.wd5.myworkdayjobs.com/en-US/External/job/Remote/Engineer_R123");
    assertThat(candidates)
        .contains("https://acme.wd5.myworkdayjobs.com/External/job/Remote/Engineer_R123");
  }
  ...
  void buildWorkdayUrlCandidatesUsesSiteWhenMissing() {
    List<String> candidates =
        service.buildWorkdayUrlCandidates(
            "acme.wd5.myworkdayjobs.com", "External", "job/Remote/Engineer_R123");
    assertThat(candidates).isNotEmpty();
    assertThat(candidates.getFirst())
        .isEqualTo("https://acme.wd5.myworkdayjobs.com/en-US/External/job/Remote/Engineer_R123");
  }
  ...
  void buildWorkdayUrlCandidatesPrefersSiteForAbsoluteMissingSite() {
    ...
    assertThat(candidates.getFirst())
        .isEqualTo("https://acme.wd5.myworkdayjobs.com/en-US/External/job/Remote/Engineer_R123");
    assertThat(candidates).contains("https://acme.wd5.myworkdayjobs.com/job/Remote/Engineer_R123");
  }
  ...
  void buildWorkdayUrlCandidatesKeepsAbsoluteWhenSitePresent() {
    ...
    assertThat(candidates).isNotEmpty();
    assertThat(candidates.getFirst())
        .isEqualTo("https://acme.wd5.myworkdayjobs.com/External/job/Remote/Engineer_R123");
  }
}
