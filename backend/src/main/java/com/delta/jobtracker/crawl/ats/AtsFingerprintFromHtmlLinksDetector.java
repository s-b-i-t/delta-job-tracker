...
/**
 * Extract ATS endpoints by scanning anchor hrefs within HTML documents. The detector keeps results
 * de-duplicated and preserves the source href for each endpoint.
 */
@Component
