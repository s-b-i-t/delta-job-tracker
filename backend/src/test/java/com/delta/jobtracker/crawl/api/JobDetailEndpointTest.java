...
class JobDetailEndpointTest {
  ...
  void jobDetailReturnsDescription() {
    ...
    long companyId =
        repository.upsertCompany("JD" + suffix, "Jobs Detail Co " + suffix, "Technology");
    ...
    JobPostingListView listItem =
        repository.findNewestJobs(10, companyId, null, true, null).getFirst();
