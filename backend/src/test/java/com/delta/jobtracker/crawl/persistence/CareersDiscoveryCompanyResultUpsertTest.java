...
class CareersDiscoveryCompanyResultUpsertTest {
    ...
    void upsertUpdatesDiscoveryCompanyResult() {
        ...
        long companyId = repository.upsertCompany("CD" + suffix, "Careers Discovery " + suffix, "Technology");
        ...
        List<CareersDiscoveryCompanyResultView> results = repository.findCareersDiscoveryCompanyResults(runId, null, 10);
